...
# 2D
prefix = "./profiles/"
airfoilProfilePS = prefix + "RAE2822PS.profile"
airfoilProfileSS = prefix + "RAE2822SS.profile"
ZSpan = 0.01  # width in the z direction
nSpan = 2  # how many points in z
# PS parameters
dX1PS = 0.00075  # first dx from the LE
Alpha1PS = 1.1  # clustering from the LE
dX2PS = 1.5e-4  # first dx from the TE
Alpha2PS = 1.1  # clustering from the TE
dXMaxPS = 0.004  # max dx for PS
# SS parameters
dX1SS = 0.00075  # first dx from the LE
Alpha1SS = 1.1  # clustering from the LE
dX2SS = 1.5e-4  # first dx from the TE
Alpha2SS = 1.1  # clustering from the TE
dXMaxSS = 0.004  # max dx for SS
# TE parameters
NpTE = 10  # number of points for blunt TE
# 3D
NpExtrude = 190  # how many points to extrude for the 3D volume mesh in y
yWall = 5e-6  # first layer mesh length
