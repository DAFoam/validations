...
# PS parameters
dX1PS = 0.001  # first dx from the LE
Alpha1PS = 1.1  # clustering from the LE
dX2PS = 2e-4  # first dx from the TE
Alpha2PS = 1.1  # clustering from the TE
dXMaxPS = 0.005  # max dx for PS
# SS parameters
dX1SS = 0.001  # first dx from the LE
Alpha1SS = 1.1  # clustering from the LE
dX2SS = 2e-4  # first dx from the TE
Alpha2SS = 1.1  # clustering from the TE
dXMaxSS = 0.005  # max dx for SS
# TE parameters
NpTE = 11  # number of points for blunt TE
# 3D
NpExtrude = 129  # how many points to extrude for the 3D volume mesh in y
